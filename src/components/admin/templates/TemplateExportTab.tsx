 ...
 * Template Export Tab
 * 
 * Extracted from TemplateExportPage — provides export configuration,
 * preview, and download options for the current site as a reusable template.
 */
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Export your current site as a reusable template
            </CardDescription>
          </CardHeader>
