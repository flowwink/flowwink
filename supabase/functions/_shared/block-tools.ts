...
export const BLOCK_CREATION_TOOLS = [
  ...
  },
  {
    "type": "function",
    "function": {
      "name": "create_consultant_matcher_block",
      "description": "Create a Consultant Matcher section: Natural-language search that matches visitor needs to consultant profiles from the Consultants module. Renders as a search field with AI-ranked matches.",
      "parameters": {
        "type": "object",
        "properties": {
          "title": {
  ...
  },
  {
    "type": "function",
    "function": {
      "name": "create_handbook_block",
      "description": "Create a Handbook section: Employee/company handbook layout with chapter navigation and optional search. Data-driven from the Handbook module.",
      "parameters": {
        "type": "object",
        "properties": {
          "title": {
          ...
          "maxChapters": {
            "description": "Max chapters to render",
            "type": "number"
          },
          "layout": {
            "description": "Layout style",
