    ...
    },
    {
      ...
      data: {
        ...
        features: [
          ...
          { id: 'mcl-cursor', icon: 'Code2', title: 'Cursor & coding agents', description: 'Query real business data while building, or drive test scenarios through the same interface production uses.' },
...
const procureToPay = processPage({
  ...
  steps: [
    ...
    { title: 'Raise the order', description: 'A purchase order is created against a vendor with agreed terms, dispatched by email, and every revision is kept.', icon: 'FileSignature' },
...
const recordToReport = processPage({
  ...
  steps: [
    ...
    { title: 'Report', description: 'Profit and loss, balance sheet, VAT return and statutory export files — generated from the ledger, not reassembled in a spreadsheet.', icon: 'FileBarChart' },
  ],
  modules: [
    ...
    { icon: 'BarChart3', title: 'Analytics', description: 'Financial KPI reporting on top of the ledger.' },
