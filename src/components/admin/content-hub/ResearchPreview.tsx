  ...
  return (
    <ScrollArea className="h-[500px] pr-4">
      <div className="space-y-4">
        {/* Honesty first (#97 A2): "research" here is generative, not fetched.
            Without this line, "Competitive Landscape" and "SEO Insights" read
            as web research that never happened. */}
        <ProvenanceLine icon={Sparkles}>
          Generated by the model from your brief, your recent published pieces and your past
          angle picks — no live web search.
        </ProvenanceLine>
